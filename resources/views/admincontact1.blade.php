...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <div class="container">
  <h2>Vous pouvez ici consulter les Messages </h2>     
  <table class="table table-striped">
    ...
    foreach ($tablo as $i){
      ...
      <td><a class='btn btn-danger' href= 'http://localhost/cms2/public/supprimercommentaire?rn=<?php echo $variable0;?>'>Supprimer le Messages</a></td>
      <td><a class='btn btn-success' href= 'http://localhost/cms2/public/repondrecommentaire?rn=<?php echo $variable0;?>'> Repondre au Messages</a></td>
      </tr>
      <?php }
        ?>
    </tbody>
