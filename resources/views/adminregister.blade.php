...
<body>
	...
	<div class="main-w3layouts wrapper">
		<h1>S'inscrire en tant que administrateur</h1>
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="adminregister1" method="get">
                @csrf
				...
				<p>Déja inscri ? <a href="http://localhost/cms2/public/adminlogin"> S'identifier maintenant</a></p>
			</div>
		</div>
		<!-- copyright -->
