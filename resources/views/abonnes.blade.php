...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Abonnés</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Abonnés</a></li>
    ...
    <!-- Main content -->
    <div class="container">
  <h2>Vous pouvez ici consulter les abonnés</h2>     
  <table class="table table-striped">
    ...
    foreach ($tablo1 as $i){
      ...
      <td><a class='btn btn-success' href= 'http://localhost/cms2/public/supabon?rn=<?php echo $variable0;?>'>Supprimer abonné</a></td>
