...
<div class="wrapper">
  ...
  <table class="table">
    <head>
      <tr>
        ...
        <th>ID Du Client</th>
        <th>Banissement (Désactivation)</th>
      </tr>
    </head>
    <body>
      <tr>
 ...
 <tr>
      ...
      <td><a class='btn btn-danger' href= 'http://localhost/cms2/public/supprimerclient?rn=<?php echo $variable3;?>'>Désactivation du compte</a></td>
      </tr>
      <?php }
        ?>
        </form>
